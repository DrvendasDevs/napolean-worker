...
export const DEFAULT_TEMPLATES: Record<TemplateKey, string> = {
  text_received:
    'Este canal é exclusivo para processamento de avaliações comerciais.\n\n' +
  ...
  unsupported_file:
    'O formato enviado não é aceito para avaliação.\n\n' +
    'Envie um arquivo de áudio da ligação ou um documento (PDF, TXT, MD ou DOCX) com a transcrição.',
  unauthorized:
    'Este número não está autorizado a solicitar avaliações.\n\n' +
...
const ALLOWED_VARS: (keyof TemplateVars)[] = [
  'nome_usuario',
  'nome_empresa',
  'nome_arquivo',
  'tipo_arquivo',

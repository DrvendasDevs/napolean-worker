...
export function buildReportMarkdown(header, ev) {
    const lines = [];
...
function aggregateStageItems(ev, field) {
    const seen = new Set();
    const out = [];
...
export function buildSummary(header, ev) {
...
export function generateReportPdf(header, ev) {
...
export function generateTranscriptionPdf(header, transcription) {
    return pdfToBuffer((doc) => {
